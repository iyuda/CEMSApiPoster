...
using System.Configuration;
    ...
    public class DbConnect
    {
        ...
        public static string ConnectionString = GetFixedConnectionString(ConfigurationManager.ConnectionStrings["localSQL"].ToString());		
        ...
        public static DataTable GetDataTable(MySqlConnection cn, string SelectQuery)
            {

            DataTable dt = new DataTable();
            MySqlDataAdapter Adapter;
            Adapter = new MySqlDataAdapter(SelectQuery,cn);

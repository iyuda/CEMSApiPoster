...
{
     public class messages_received: BaseClass
        {
          ...
          public messages_received() { TableName = "messages_received"; }
          public messages_received(string id)
               : base(id, "messages_received")
               {

               }
          public messages_received(string TableName, JsonInputSection PcrObj)

...
namespace WebApiPoster.Models
    ...
    public class Business:BaseClass 
        ...
        public void MapIntoIOSJson(string PathPrefix)
        {
             ...
             JsonMaker.UpdateJsonValue(PathPrefix + "_Facility", this.name);
        }
             ...
             
        {
             ...
             this.name = JsonMaker.GetIOSJsonExtract(PathPrefix + "_Facility", JsonData);
        ...
        public string GetFacilityIdByName()
            ...
            using (MySqlConnection cn = new MySqlConnection(DbConnect.ConnectionString))
                {
                cn.Open();
                string SqlString = "select id from business where name = '" + this.name.Replace("'", @"\'") + "'";
        ...
        public string GetAddressID()
        {
             ...
             {
                  cn.Open();
                  string SqlString = "select address from business_addresses where business = '" + this.id + "'";
                  MySqlCommand cmd = new MySqlCommand(SqlString, cn);
                  string rv = (string)cmd.ExecuteScalar();
                  //rv = rv == null ? "" : rv.ToString();
                  return rv;

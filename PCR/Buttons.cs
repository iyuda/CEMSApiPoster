...
//        public All_Buttons button_object { get; set; }
        ...
        public bool LoadButton(string Path, string SubPath, string SearchField="id", string SearchValue="")
        {
             ...
             return JsonMaker.ModifyArrayItem("$.['" + Path + "'].['" + SubPath + "'].['model'].['buttons']", SearchField, SearchValue, "choice", "on");
        }
        ...
        public void SaveButton(object JsonData, string pcr_id = "", string button_id="", string SectionName="")
        {
             try
             {
                  ...
                  if (this.button_id != null)
                  {
                       ...
                       if (choice + "" == "on") this.HandleRecord();
                  }
